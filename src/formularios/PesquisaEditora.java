 ...
 * @author Paulo
 */
public class PesquisaEditora extends javax.swing.JDialog implements Selecionavel<Editora> {
    ...
    private Editora selecionado;
    private SelecionaItem selecionaItem;

    public PesquisaEditora(JFrame pai) {
        super(pai, "Consulta de Editora", true);
        initComponents();
        lista = new ArrayList<>();
        setTabela();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pesquisa Editora");
